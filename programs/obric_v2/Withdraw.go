...
// SetLpAmountX sets the "lpAmountX" parameter.
func (inst *Withdraw) SetLpAmountX(lpAmountX uint64) *Withdraw {
	inst.LpAmountX = &lpAmountX
	return inst
}

// SetLpAmountY sets the "lpAmountY" parameter.
func (inst *Withdraw) SetLpAmountY(lpAmountY uint64) *Withdraw {
	inst.LpAmountY = &lpAmountY
	return inst
}

// SetTradingPairAccount sets the "tradingPair" account.
func (inst *Withdraw) SetTradingPairAccount(tradingPair ag_solanago.PublicKey) *Withdraw {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(tradingPair).WRITE()
	return inst
}

// GetTradingPairAccount gets the "tradingPair" account.
func (inst *Withdraw) GetTradingPairAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetMintXAccount sets the "mintX" account.
func (inst *Withdraw) SetMintXAccount(mintX ag_solanago.PublicKey) *Withdraw {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(mintX)
	return inst
}

// GetMintXAccount gets the "mintX" account.
func (inst *Withdraw) GetMintXAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetMintYAccount sets the "mintY" account.
func (inst *Withdraw) SetMintYAccount(mintY ag_solanago.PublicKey) *Withdraw {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(mintY)
	return inst
}

// GetMintYAccount gets the "mintY" account.
func (inst *Withdraw) GetMintYAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetReserveXAccount sets the "reserveX" account.
func (inst *Withdraw) SetReserveXAccount(reserveX ag_solanago.PublicKey) *Withdraw {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(reserveX).WRITE()
	return inst
}

// GetReserveXAccount gets the "reserveX" account.
func (inst *Withdraw) GetReserveXAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetReserveYAccount sets the "reserveY" account.
func (inst *Withdraw) SetReserveYAccount(reserveY ag_solanago.PublicKey) *Withdraw {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(reserveY).WRITE()
	return inst
}

// GetReserveYAccount gets the "reserveY" account.
func (inst *Withdraw) GetReserveYAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetUserTokenAccountXAccount sets the "userTokenAccountX" account.
func (inst *Withdraw) SetUserTokenAccountXAccount(userTokenAccountX ag_solanago.PublicKey) *Withdraw {
...
func (inst *Withdraw) GetUserTokenAccountXAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetUserTokenAccountYAccount sets the "userTokenAccountY" account.
func (inst *Withdraw) SetUserTokenAccountYAccount(userTokenAccountY ag_solanago.PublicKey) *Withdraw {
...
func (inst *Withdraw) Validate() error {
	...
	{
		if inst.LpAmountX == nil {
			return errors.New("LpAmountX parameter is not set")
		}
		if inst.LpAmountY == nil {
			return errors.New("LpAmountY parameter is not set")
		}
	}
			...
			programBranch.Child(ag_format.Instruction("Withdraw")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Params[len=2]").ParentFunc(func(paramsBranch ag_treeout.Branches) {
						paramsBranch.Child(ag_format.Param("LpAmountX", *inst.LpAmountX))
						paramsBranch.Child(ag_format.Param("LpAmountY", *inst.LpAmountY))
					})
...
func (obj Withdraw) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Serialize `LpAmountX` param:
	err = encoder.Encode(obj.LpAmountX)
	if err != nil {
		return err
	}
	// Serialize `LpAmountY` param:
	err = encoder.Encode(obj.LpAmountY)
	if err != nil {
		return err
	}
	return nil
...
func (obj *Withdraw) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `LpAmountX`:
	err = decoder.Decode(&obj.LpAmountX)
	if err != nil {
		return err
	}
	// Deserialize `LpAmountY`:
	err = decoder.Decode(&obj.LpAmountY)
	if err != nil {
		return err
	}
	return nil
...
func NewWithdrawInstruction(
	...
	return NewWithdrawInstructionBuilder().
		SetLpAmountX(lpAmountX).
		SetLpAmountY(lpAmountY).
